...
class GraphicCourse extends StatelessWidget {
  @override
              ...
              children: [
                ...
                FutureBuilder<String?>(
                  future: Future.value(YoutubePlayer.convertUrlToId(
                      'https://youtu.be/GQS7wPujL2k?si=9_taMzlPfROeXNbD')),
                ...
                EpisodeListItem(
                  episodeTitle: 'Episode 1: Introduction to Graphic Design',
                  onPressed: () {
                    // Logic when Episode 1 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 2: Principles of Visual Composition',
                  onPressed: () {
                    // Logic when Episode 2 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 3: Typography Fundamentals',
                  onPressed: () {
