...
class PhytnCourse extends StatelessWidget {
  @override
              ...
              children: [
                ...
                FutureBuilder<String?>(
                  future: Future.value(YoutubePlayer.convertUrlToId(
                      'https://youtu.be/rfscVS0vtbw?si=5PloS-WcCe1DvzyQ')),
                ...
                EpisodeListItem(
                  episodeTitle: 'Episode 1: Introduction to Python',
                  onPressed: () {
                    // Logic when Episode 1 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 2: Python Basics',
                  onPressed: () {
                    // Logic when Episode 2 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 3: Working with Data in Python',
                  onPressed: () {
