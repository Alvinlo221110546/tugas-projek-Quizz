...
class PhotoCourse extends StatelessWidget {
  @override
              ...
              children: [
                ...
                FutureBuilder<String?>(
                  future: Future.value(YoutubePlayer.convertUrlToId(
                      'https://youtu.be/IyR_uYsRdPs?si=LuH6J-g5DIrBSD1U')),
                ...
                EpisodeListItem(
                  episodeTitle: 'Episode 1: Introduction to Photography',
                  onPressed: () {
                    // Logic when Episode 1 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 2: Camera Basics',
                  onPressed: () {
                    // Logic when Episode 2 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 3: Composition Techniques',
                  onPressed: () {
