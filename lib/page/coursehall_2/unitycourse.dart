...
class UnityCourse extends StatelessWidget {
  @override
              ...
              children: [
                ...
                FutureBuilder<String?>(
                  future: Future.value(YoutubePlayer.convertUrlToId(
                      'https://youtu.be/AmGSEH7QcDg?si=MKhMC1G6bn8qo173')),
                ...
                EpisodeListItem(
                  episodeTitle: 'Episode 1: Introduction to Unity',
                  onPressed: () {
                    // Logic when Episode 1 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 2: Unity Basics',
                  onPressed: () {
                    // Logic when Episode 2 button is pressed
                  },
                ),
                EpisodeListItem(
                  episodeTitle: 'Episode 3: Building Your First Game',
                  onPressed: () {
